...
///  * this HomeController is not the initialViewController of your Storyboard, but a different scene
///
...
public extension StoryboardSceneBased where Self: UIViewController {
  /**
   Create an instance of the HomeController from its associated Storyboard and the
